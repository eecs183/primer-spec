...
* Although you are welcome to work alone if you wish, we encourage you to consider partnering up for Project 3. If you would like a partner but don't know anyone in the class, we encourage you to use the [Search for Teammates post](https://piazza.com/class/lzh4pxb3haz135/post/5) on Piazza if you want to find someone! Please make sure to mark your search as *Done* once you've found a partner.
...
* If you decide to work with a partner, be sure to review [the guidelines for working with a partner](https://eecs183.github.io/docs/partners.html).
* If you choose to use late days and you are working in a partnership, review [this section](https://eecs183.github.io/docs/partners.html#late-days-and-partnerships) for how late days will be charged against each partner.
